  ...
  return (
    <section className="relative min-h-[110vh] flex flex-col items-center justify-center overflow-hidden w-full">
      ...
      >
        ...
        >
          Nihonbuzz Academy lahir dari semangat untuk menghadirkan pengalaman belajar bahasa dan budaya Jepang yang tidak sekadar informatif, tetapi juga inspiratif. Kami percaya bahwa bahasa adalah jembatan peradaban, dan melalui bahasa Jepang, terbentang kesempatan luas bagi siapa pun yang ingin menapaki dunia baru, baik dalam pendidikan, karier, maupun pengembangan diri. Dengan memadukan metode pembelajaran modern, pendekatan interaktif, serta bimbingan pengajar yang berpengalaman, kami berupaya menciptakan ruang belajar yang hangat, relevan, dan penuh makna. Lebih dari sekadar kursus, Nihonbuzz Academy adalah mitra perjalanan, yang menemani setiap langkah generasi muda Indonesia dalam mengenal, memahami, dan merangkai masa depan melalui bahasa dan budaya Jepang.
        </motion.p>
